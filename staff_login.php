...
if(isset($_POST['submit'])){
    ...
    $query = "SELECT * FROM `staff_table2` WHERE `staffno`='$staffno' && `password`='$password'";
...
<div class="container-fluid">
    ...
    <div class="col-9"><br>
    <h3 class="text-center">Login as a staff here</h3><br>
    <div class="jumbotron">

    <h2><strong><em>Login<em></strong></h2>
    <form action="" method="post"><hr class="bg-dark">
    <div class="form-group">
    <label for="">Staff No</label><br>
    <input class="form-control" type="text" name="staffno" placeholder="Enter staff no here">
    </div>
    <div class="form-group">
