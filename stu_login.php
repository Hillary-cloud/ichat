...
if(isset($_POST['submit'])){
    ...
    $query = "SELECT * FROM `student_table` WHERE `regno`='$regno' && `password`='$password'";
...
<div class="container-fluid">
    ...
    <div class="col-9"><br>
    <h3 class="text-center">Login as a student here</h3><br>
    <div class="jumbotron">

    <h2><strong><em>Login<em></strong></h2>
    <form action="" method="post"><hr class="bg-dark">
    <div class="form-group">
    <label for="">Matric No</label><br>
    <input class="form-control" type="text" name="regno" placeholder="Enter your matric number here">
    </div>
    <div class="form-group">
